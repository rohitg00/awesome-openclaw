...
| **Mnemosyne Memory Engine** | Zero-dependency local memory engine for OpenClaw: 271KB runtime, no LLM API, no vector DB, pure Markdown storage, TF-IDF + KNN search, 7-way parallel retrieval, heartbeat heatmap, user profiling, and Git-friendly memory files | [GitHub](https://github.com/ElonAug7/openclaw-mnemosyne-memory-engine) |
