...
| **Product Manager Skills** | Senior PM agent for Claude Code — 6 knowledge domains, 30+ frameworks, 32 SaaS metrics with formulas, 12 templates, anti-pattern detection. Pure Markdown, MIT-0 license. | [GitHub](https://github.com/Digidai/product-manager-skills) |
