...
| **Ariadne Loop** | Verifiable loop-engineering skill for OpenClaw, Codex, and Claude Code workflows with loop specs, gates, JSON reports, and handoff packets | [GitHub](https://github.com/zhangzeyu99-web/ariadne-loop/tree/main/skills/ariadne-loop) |
