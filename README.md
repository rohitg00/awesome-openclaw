...
|------|------|-------------|
| **[Keep My Claw](https://keepmyclaw.com)** | Paid skill ($5/mo or $19/yr) | Encrypted cloud backup to Cloudflare R2. Backs up workspace, memory, cron jobs, skills, credentials, and config. Client-side encryption, scheduled backups, snapshot verification, and cross-machine restore. Install: `clawhub install keepmyclaw` ([ClawHub](https://clawhub.com/Ryce/keepmyclaw)) |
