...
| **OculOS** | Desktop control for agents — exposes the OS accessibility tree (every button, text field, menu of every app) as a JSON API so OpenClaw can click, type, and read native apps deterministically. REST + MCP, single binary, Windows/Linux/macOS, no vision model | [GitHub](https://github.com/huseyinstif/oculos) |
